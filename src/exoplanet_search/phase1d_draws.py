...
class Phase1DSourceRequirements:
    ...
    def validate(self, config: Phase1CConfig, mode: str) -> dict[str, Any]:
        expected = {
            ...
            "diagnostic_methodology_version": self.diagnostic_methodology_version,
        ...
        observed = {
            ...
            "diagnostic_methodology_version": str(config.diagnostic_methodology_version),
...
def _validate_authoritative_diagnostic_criteria(
    ...
    if diagnostics.get("diagnostic_methodology_version") != DIAGNOSTIC_METHODOLOGY_VERSION:
        raise ValueError("Authoritative diagnostics were not generated by the current diagnostic methodology.")
    ...
    history_flags = {
        ...
        "no_severe_walker_pathology": "walker health",
    }
    ...
    if str(final_history_row.get("diagnostic_methodology_version", "")) != DIAGNOSTIC_METHODOLOGY_VERSION:
        raise ValueError("Final convergence-history row was not generated by the current diagnostic methodology.")
